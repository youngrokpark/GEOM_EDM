...
def sample(args, device, generative_model, dataset_info,
           ...
           fix_noise=False, time_classifier=None):
    ...
    if args.probabilistic_model == 'diffusion':
        x, h = generative_model.sample(batch_size, max_n_nodes, node_mask, edge_mask, context, args, fix_noise=fix_noise, time_classifier=time_classifier)
